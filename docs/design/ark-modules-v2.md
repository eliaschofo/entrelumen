...
| Habitabilidad | **Hogar:** habilita `/sethome` y `/home`. | decidido |
...
- **Casas.** Hasta 3 por jugador, con nombre; `/home` sin nombre va a la primera. Funciona entre dimensiones. Enfriamiento de 30 s. No se puede marcar ni usar una casa en Solsticio, donde se entra y se sale con la Llave.

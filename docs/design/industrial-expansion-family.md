...
| Torchmaster · `torchmaster-neoforge-1.21.1-21.1.9.jar` (254268 / 7197218) | QoL: spawn control | II: mega torch protects a settled base | All acts: dread lamp for deliberate spawn areas | Settlement safety beside FTB Chunks claims; no mob farm on its own |

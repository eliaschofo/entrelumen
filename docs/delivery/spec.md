...
Final acceptance compares frozen editions using consistent units and requires parity with the largest reference. See [scale-reference.md](../design/scale-reference.md): ATM10 8.1 has 4,790 structurally counted unique quests locally; Craftoria 1.36.0 exports 560 CF references, not necessarily all mods. Current FTB Evolution 1.43.1 counts and Craftoria's complete loaded quest total remain unmeasured. Provisional targets do not prove parity: complete these measurements before final scope acceptance and raise targets if necessary.
